...
function Navbar({handletheme,theme})
{
    ...
    <div className={"navbar"+theme}>
        ...
        <a href={"/sanchit_portfolio/#info"+theme} onClick={handlemenu} className={"navbutton"+theme}>ABOUT</a>
        <a href={"/sanchit_portfolio/#skills"+theme} onClick={handlemenu} className={"navbutton"+theme}>SKILLS</a>
        <a href={"/sanchit_portfolio/#projects"+theme} onClick={handlemenu} className={"navbutton"+theme}>PROJECTS</a>
        <a href={"/sanchit_portfolio/#github"+theme} onClick={handlemenu} className={"navbutton"+theme}>GITHUB</a>
        <a href={"/sanchit_portfolio/#contact"+theme} onClick={handlemenu} className={"navbutton"+theme}>CONTACT</a>
